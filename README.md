...
<p align="center">
  <img src="results/50K.png" alt="Quadrants generated by the Barnes-Hut approximation" />
</p>
...
ffmpeg -framerate 30 -i results/frames/frame_%04d.bmp -vf "scale=800:-1:flags=lanczos" -pix_fmt rgb8 ./results/simulation.gif
...
The output MP4 video is approximately 20MB in size. I added a `frame2vide.sh` script to automate the conversion process.
...
<p align="center">
  <img src="report-presentation/figures/benchmark_results.png" alt="Quadrants generated by the Barnes-Hut approximation" />
</p>
